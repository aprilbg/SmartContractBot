...
public class Transaction_DB_nft : DbContext
{
    ...
    public string connectionString { get; protected set;} ="server=10.120.10.109;user=root;password=Dstamp~!23;pooling=True;min pool size=50;database=Transaction_DB_NFT;";
